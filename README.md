...
Realpolitik is a browser-based prototype for an interactive 2D geopolitical map. The current build focuses on showing estimated alignment likelihoods, escalation risk, transparent assumptions, and inspectable country-to-country relationships rather than claiming deterministic predictions.
...
- Add scenario editing for sanctions, elections, invasions, coups, and treaty changes
- Compare baseline and edited scenarios with saved assumption sets
