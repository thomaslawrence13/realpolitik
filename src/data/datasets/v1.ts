...
export const geopoliticalDatasetV1: DatasetBundle = {
  ...
  methodologyNotes: [
    ...
    'Live World Bank enrichment (GDP growth, inflation, trade openness, rule of law, unemployment) reconciles against the curated snapshot at runtime with deterministic source priority and coverage-aware fallbacks. Staleness is surfaced, not hidden.',
    'Risk and alignment reflect observed state only — current indicators, relationships, and recorded posture — with no scenario offsets, momentum terms, or probabilistic forecasts.',
